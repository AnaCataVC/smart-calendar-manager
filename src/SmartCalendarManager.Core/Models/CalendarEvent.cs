...
/// <summary>
/// Represents a calendar event with meeting detection and action trigger properties.
/// </summary>
public class CalendarEvent
{
    ...
    /// <summary>
    /// Gets or sets the optional meeting link URL (Google Meet, Zoom, Teams, Webex).
    /// </summary>
    ...
    /// <summary>
    /// Formatted start time string (e.g. 9:30 AM or Todo el día).
    /// </summary>
    public string FormattedStartTime => IsAllDay ? "Todo el día" : StartTime.ToString("h:mm tt");

    /// <summary>
    /// Formatted end time string (e.g. 10:30 AM or Todo el día).
    /// </summary>
    ...
    /// <summary>
    /// Gets the dynamic status description text based on the current time and action trigger eligibility.
    /// </summary>
